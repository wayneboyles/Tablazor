...
internal sealed class FormSection
{
    ...
    /// precedes any explicitly-labeled section.
    /// </summary>
    ...
    /// <summary>
    /// When <c>true</c>, the section body can be collapsed by clicking the header.
    /// </summary>
    public bool Collapsible { get; init; }

    /// <summary>
    /// Initial collapsed state when <see cref="Collapsible"/> is <c>true</c>.
    /// </summary>
    public bool InitiallyCollapsed { get; init; }

    /// <summary>
    /// Additional CSS class(es) for the section wrapper element.
    /// </summary>
    public string? CssClass { get; init; }

    /// <summary>
    /// The ordered rows of fields belonging to this section.
    /// </summary>
    public List<FormRow> Rows { get; init; } = new();

    /// <summary>
    /// <c>true</c> when a non-blank title is set.
    /// </summary>
