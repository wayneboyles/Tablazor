...
internal static class TabIconsRenderer
{
    ...
    private static bool IsFilledIcon(string pathData)
    {
        ...
        var fields = filledIconsType.GetFields(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);

        return fields.Any(f => f.GetValue(null) as string == pathData);
    }
}